...
BOT_TOKEN = environ.get('BOT_TOKEN', '7822605841:AAFGSKk68KfV1tsBA7SSsRn_CM1-ZuVk7Oo')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/MoviesGroupG3')
...
TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "1400"))
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "1400"))
#---------------------------------------------------------------
#---------------------------------------------------------------
LANGUAGES = ["hindi", "english", "telugu", "tamil", "kannada", "malayalam", "gujarati", "punjabi"]
QUALITIES = ["HdRip","web-dl" ,"bluray", "hdtc", "hd" , "480p", "720p", "1080p", "1440p", "2K", "2160p", "4k"]
